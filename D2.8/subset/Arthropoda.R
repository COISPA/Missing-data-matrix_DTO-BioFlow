# Arthropoda QUERY_subsets #

#Arthropoda - NO NA - NO Copepoda - NO Malacostraca
subdata_1 <- emodnet_get_layers(wfs = wfs_bio, layers = "eurobis", reduce_layers = T, outputFormat = "CSV", crs=4326, 
                                cql_filter = "(phylum='Arthropoda') AND class NOT LIKE 'Copepoda%' AND class NOT LIKE 'Malacostraca%' AND class IS NOT NULL AND aphiaidaccepted IS NOT NULL",
